    ...
    def on_arrive(self):
        if self.scene.config['savegame']['bathroom']['valve']:
            ...
            if 'Rohrzange' in self.scene.cursor.item:
                ...
                self.scene.bg_lst['pipe_flow2'].pause = False
...
class Bathroom(Scene):
    def __init__(self, player, cursor, collision_file = None, scale_factor=6, dev=False, config = None):
        ...
        pipe_flow1 = StripAnimate('scenes/bathroom/dripping_flow1.png', img_width = 320, frame_rate = 9, scale_factor = scale_factor, once = True, pause = True)
        pipe_flow2 = StripAnimate('scenes/bathroom/dripping_flow2.png', img_width = 320, frame_rate = 9, scale_factor = scale_factor, pause = True)
        ...
        self.bg_lst = {'bg': 'scenes/bathroom/bg.png', 'pipes': 'scenes/bathroom/pipes.png', 'pipe_shadow': 'scenes/bathroom/pipe_shadow.png',
                       ...
                       'pipe_flow1': pipe_flow1, 'pipe_flow2': pipe_flow2}
        ...
        if self.config['savegame']['bathroom']['valve']: self.clickable_lst.update({'top_change_scene': ChangeScene(pg.Rect((1550, 0, 200, 820)), 1, hover_cursor = 5)})